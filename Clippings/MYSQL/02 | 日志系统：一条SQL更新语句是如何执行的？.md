...
source: https://time.geekbang.org/column/article/68633
author:
  - thomas
published:
created: 2026-05-17
description: 文章总结：介绍了MySQL日志系统的执行流程和重要日志模块redo log和binlog的设计原理，以及两阶段提交的必要性。强调了WAL技术提升更新效率和保证数据库的crash-safe能力，展现了MySQL技术的独特之处。同时提出思考题，引发读者思考。
tags:
  - MYSQL
---
