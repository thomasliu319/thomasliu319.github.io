---
title: "事务隔离：为什么你改了我还看不见？-MySQL实战45讲-极客时间"
source: "https://time.geekbang.org/column/article/68963"
author:
  - "thomas"
published:
created: 2026-05-17
description: "本文介绍了MySQL事务隔离级别的重要性和实现原理，以及长事务对数据库性能的影响。建议根据业务情况选择合适的隔离级别，并避免长事务。同时，提供了启动事务的方式和查询长事务的方法。总结了如何避免长事务的正确方式。"
tags:
  - "MYSQL"
---
...
![](https://static001.geekbang.org/resource/image/d9/ee/d9c313809e5ac148fc39feff532f0fee.png?wh=1142*737)
...
select \* from information\_schema.innodb\_trx where TIME\_TO\_SEC(timediff(now(),trx\_started))>60
