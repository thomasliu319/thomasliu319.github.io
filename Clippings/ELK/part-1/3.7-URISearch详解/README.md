...
#使用引号,Phrase查询
GET /movies/_search?q=title:"Beatiful Mind"
{
		"profile":"true"
}

#分组，Bool查询
GET /moives/_search?q=title:(Beautiful Mind)
{
		"profile":"true"
}
...
#查找美丽心灵
GET /movies/_search?q=title:(Beatiful %2BMind)
{
		"profile":"true"
} 
...
GET /moives/_search?q=title:"Lord Rings"~2
{
		"profile":"true"
}
