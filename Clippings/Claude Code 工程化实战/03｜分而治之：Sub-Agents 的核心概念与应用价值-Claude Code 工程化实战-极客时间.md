---
title: 03｜分而治之：Sub-Agents 的核心概念与应用价值-Claude Code 工程化实战-极客时间
source: https://time.geekbang.org/column/article/943368?utm_source=u_nav_web&utm_medium=u_nav_web&utm_term=u_nav_web
author:
  - thomas
published:
created: 2026-05-09
description: 子代理(Sub-Agents)是Claude Code工程化实战中的核心概念，旨在解决上下文污染问题。通过隔离、约束和复用，有效地将执行过程中的噪声隔离出去，只保留有价值的结论。子代理的配置文件格式和位置，以及创建方式都得到了详细的介绍。子代理的核心工程化能力归结为隔离、约束、复用和并行。在配置层面，关键字段包括`name`、`description`、`tools`和`model`。适用于处理高
tags:
  - ClaudeCode
---
...
![](https://static001.geekbang.org/resource/image/83/6b/83faca2955fec9918cde91336954436b.png?wh=1125x655)

专业的 Agents 做专业的事儿

![](https://static001.geekbang.org/resource/image/bf/40/bff23d0b23e5cf0517ec0f42d3c97140.jpg?wh=2626x1624)
...
![](https://static001.geekbang.org/resource/image/cb/77/cb46b69c3fe2d551635019829d97b777.png?wh=2078x1476)
...
![](https://static001.geekbang.org/resource/image/f5/c5/f5376b6df040e7ab608cc636f35224c5.jpg?wh=896x428)
...
![](https://static001.geekbang.org/resource/image/75/81/75dcb95964d90e48d6a80fe25edc0f81.png?wh=2415x1095)
...
![](https://static001.geekbang.org/resource/image/43/e8/4300cf4660d830b21b96b7f6bdb960e8.png?wh=2378x1193)
...
![](https://static001.geekbang.org/resource/image/54/cf/5425ae5d7b516fa10f1bd76ae4c09acf.jpg?wh=2436x1663)
...
![](https://static001.geekbang.org/resource/image/71/d6/71cd4c92058b3c50239712630fd338d6.jpg?wh=4127x2034)

permissionMode：权限模式

permissionMode 控制子代理在执行过程中遇到需要权限的操作时如何处理。子代理会继承主对话的权限上下文，但可以通过此字段覆盖行为：

![](https://static001.geekbang.org/resource/image/9c/a6/9c630b6f0065eb1d725e8cd6060016a6.jpg?wh=2961x1131)
...
![](https://static001.geekbang.org/resource/image/a7/32/a72ae303f03a261b1c6e8yy4d0ae2132.jpg?wh=2420x1089)
...
![](https://static001.geekbang.org/resource/image/51/01/51f77f6bcc00d9fc27d0994914c99401.png?wh=879x281)
...
![](https://static001.geekbang.org/resource/image/5d/fc/5d5c1d1f462db70663df2688051236fc.jpg?wh=2423x892)
